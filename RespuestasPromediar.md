...
Por lo tanto a la variable nc le asigna el 0, luego a la variable  nl le asigna el 0 y el valor de la expresión es 0 que es el resultado de evaluar el operando mas a la derecha como en la OPERACIÓN COMA.
